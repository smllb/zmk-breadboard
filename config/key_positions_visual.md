...
This document provides a visual representation of the key positions for your Skeletyl keyboard.
...
Each key is identified by two numbers:
- The first number represents its position in the layout (0-35)
